(custom-set-variables
 ...
 '(package-selected-packages
   '(pdf-tools auctex which-key visual-fill-column vertico sly-quicklisp sly-named-readtables sly-macrostep sly-asdf rg paren-face paredit org-download org-bullets orderless multiple-cursors marginalia magit-filenotify lsp-ui lsp-treemacs iedit highlight-stages highlight-parentheses helpful git-timemachine git-modes git-gutter-fringe general eshell-git-prompt embark-consult dired-subtree dired-rainbow dired-quick-sort dired-preview dired-open dired-k dired-hide-dotfiles dired-git-info corfu all-the-icons-dired all-the-icons-completion))
